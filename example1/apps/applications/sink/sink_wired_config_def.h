...
#define SINK_WIRED_WRITEABLE_CONFIG_BLK_ID 967
...
#define SINK_WIRED_READONLY_CONFIG_BLK_ID 977
...
#define SPDIF_SETTINGS_CONFIG_BLK_ID 988

typedef struct {
    spdif_configuration_t SpdifConfig;
} spdif_settings_config_def_t;

#define I2S_DATA_CONFIG_BLK_ID 993
